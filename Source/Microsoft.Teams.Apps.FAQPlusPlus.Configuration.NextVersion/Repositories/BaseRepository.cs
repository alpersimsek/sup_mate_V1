...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Configuration.NextVersion.Repositories
{
        ...
        where T : TableEntity, new()
    {
        ...
        {
            var storageAccountConnectionString = "DefaultEndpointsProtocol=https;AccountName=ebwbomqhojhse;AccountKey=iQRc66nXlpsvXnHsNRsPLQvNoTw17so6eJlvk+BnZytlxQjE0cJ1MMnrojJbdav9FIjMvoHvpWfwuHE+H2hqCw==;EndpointSuffix=core.windows.net";
        ...
        {
            rowKeys = rowKeys ?? throw new ArgumentNullException(nameof(rowKeys));
